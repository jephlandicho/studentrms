        ...
        <div class="col-md-4">
            <div class="box">
                <div class="our-services settings">
                    <h4 style = "height: 100px; line-height: 50px; text-align: center;">ACADEMIC YEAR</h4>
                    <a href="admin-mng-acadyear.php">
                    <i style='color:white; font-size:50px' class='fas pb-3'>&#xf35a;</i>
                    </a>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box">
                ...
                <h4 style = "height: 100px; line-height: 50px; text-align: center;">STUDENT SCHED</h4>
                <a href="">
                    <i style='color:white; font-size:50px' class='fas'>&#xf35a;</i>
                    </a>
                </div>
        ...
        <div class="col-md-4">
            <div class="box">
                ...
                <h4 style = "height: 100px; line-height: 50px; text-align: center;">FACULTY SCHED</h4>
                <a href="">
                    <i style='color:white; font-size:50px' class='fas'>&#xf35a;</i>
                    </a>
                </div>
        ...
        <div class="col-md-4">
            <div class="box">
                ...
                <h4 style = "height: 100px; line-height: 100px; text-align: center;">DATABASE</h4>
                <a href="">
                    <i style='color:white; font-size:50px' class='fas'>&#xf35a;</i>
                    </a>
                </div>
